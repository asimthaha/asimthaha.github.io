...
(function () {
  ...
  // Update timer immediately when page loads
  ...
  function updateExperienceTimerWithAnimation() {
    const startDate = new Date("2024-07-01T00:00:00");
    const currentDate = new Date();
    const timeDifference = currentDate - startDate;
  ...
  // Initialize enhanced timer
  document.addEventListener("DOMContentLoaded", function () {
    updateExperienceTimerWithAnimation();
    setInterval(updateExperienceTimerWithAnimation, 1000);
  });
})();
